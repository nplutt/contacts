...
def user_data(request):
    data = [
        UserData(data_type='emailAddress',
                 data='nplutt@gmail.com',
                 user_id=user_id_1),
        UserData(data_type='firstName',
                 data='Nick',
                 user_id=user_id_1),
        UserData(data_type='lastName',
                 data='Plutt',
                 user_id=user_id_1),
        UserData(data_type='address',
                 data='200 Grand Avenue',
                 user_id=user_id_1),
        UserData(data_type='emailAddress',
                 data='nohn@gmail.com',
                 user_id=user_id_2),
        ...
        UserData(data_type='lastName',
                 data='Bones',
                 user_id=user_id_2),
        UserData(data_type='phone number',
                 data='612-584-9642',
                 user_id=user_id_2),
        UserData(data_type='emailAddress',
                 data='tim@gmail.com',
