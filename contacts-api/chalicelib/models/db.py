...
class Users(Base):
    ...
    add_name = Column(String, server_default=database_username)
    add_date = Column(DateTime, server_default=func.now())
    last_maintenance_name = Column(String, server_default=database_username)
    last_maintenance_date = Column(DateTime, server_default=func.now())
...
class UserData(Base):
    ...
    search_vector = Column(TSVectorType('meta_data'))
